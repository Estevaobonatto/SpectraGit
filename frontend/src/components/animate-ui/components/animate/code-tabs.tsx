    ...
    >
      <TabsHighlight className="absolute z-0 inset-0 rounded-none shadow-none bg-transparent after:content-[''] after:absolute after:inset-x-0 after:h-0.5 after:bottom-0 after:bg-white after:rounded-t-full">
        <TabsList
          ...
          className="w-full relative flex items-center justify-between rounded-none h-10 bg-muted border-b border-border/75 text-current py-0 px-4"
        >
          ...
          {copyButton && highlightedCodes && (
            <CopyButton
              ...
              size="xs"
              variant="ghost"
              className="-me-2.5 bg-transparent hover:bg-black/5"
