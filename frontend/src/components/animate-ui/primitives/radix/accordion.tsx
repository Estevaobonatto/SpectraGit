      ...
      {keepRendered ? (
        <AccordionPrimitive.Content asChild forceMount>
          <motion.div
            ...
            initial={{ height: 0, opacity: 0, '--mask-stop': '0%', y: 20 } as React.CSSProperties & { '--mask-stop': string }}
            animate={
              isOpen
                ? { height: 'auto', opacity: 1, '--mask-stop': '100%', y: 0 } as React.CSSProperties & { '--mask-stop': string }
                : { height: 0, opacity: 0, '--mask-stop': '0%', y: 20 } as React.CSSProperties & { '--mask-stop': string }
            }
          ...
          <AccordionPrimitive.Content asChild forceMount>
            <motion.div
              ...
              animate={{
                ...
                '--mask-stop': '100%',
                y: 0,
              } as React.CSSProperties & { '--mask-stop': string }}
              exit={{ height: 0, opacity: 0, '--mask-stop': '0%', y: 20 } as React.CSSProperties & { '--mask-stop': string }}
              transition={transition}
              style={{
                maskImage:
                  'linear-gradient(black var(--mask-stop), transparent var(--mask-stop))',
